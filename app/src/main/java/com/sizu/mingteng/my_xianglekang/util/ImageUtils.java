...
public class ImageUtils {
    ...
    public static void loadIntBitMap(Context context, final String imageUrl, int errorImageId, final ImageView imageView){
             /*     Glide.with(context)
                .load(imageUrl)
                .placeholder(errorImageId)
       ...
       /* Target<Bitmap> into = Glide.with(context).load(imageUrl)
                .asBitmap()
                .error(errorImageId)
                .placeholder(errorImageId)
                .dontAnimate()
